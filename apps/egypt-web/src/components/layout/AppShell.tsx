...
const NAV_ITEMS = [
  ...
  { to: '/properties', label: 'Hotels', icon: Hotel },
...
export default function AppShell() {
  ...
  const pageInfo = (() => {
    if (activePathname.startsWith('/shortlist')) {
      return {
        title: 'Henri & Evelina Shortlist',
        description: 'Properties ranked by snoring isolation, beach access & preferences.',
      }
    }
    if (activePathname.startsWith('/properties')) {
      return {
        title: 'Sharm El Sheikh Hotels',
        description: '388 properties scraped from Booking.com for Feb 15-22, 2026.',
      }
    }
